...
export default class Gantt {
    ...
    make_grid_rows() {
        const rows_layer = createSVG('g', { append_to: this.layers.grid, x: 250 });
        const lines_layer = createSVG('g', { append_to: this.layers.grid, x: 250 });
        ...
        for (let task of this.tasks) {
            ...
            createSVG('rect', {
                ...
                height: row_height,
                class: 'grid-row',
                // innerHTML: task.name + '-' + task.resource,
